...
public class TestJuicersWithPow {
    ...
    public void juiciersWithP() {
        ...
        jse.executeScript("scroll(0, 250)");
        jse.executeScript("scroll(0, 250)");
        WebElement powerFrom = wdw.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div[1]/div[3]/div[2]/div[1]/div/aside/div[9]/div[2]/div[2]/div[1]/input")));
        powerFrom.sendKeys(Keys.CONTROL + "a");
        powerFrom.sendKeys(Keys.DELETE);
        powerFrom.sendKeys("1000");
        try {
            Thread.sleep(1000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        powerFrom.sendKeys(Keys.ENTER);
        try {
            Thread.sleep(2000);
        } catch (InterruptedException e) {
            e.printStackTrace();
        ...
        jse.executeScript("scroll(0, 250)");
        WebElement addToCart = wdw.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[1]/div/div[1]/div[3]/div[2]/div[2]/div[2]/div[1]/div/div/div[1]/div/div/div[3]/div[2]/div/div/button")));
